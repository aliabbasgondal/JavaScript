...
*/
function make_album(artist_name, album_title,no_tracks=0)
{
    if(no_tracks==0)
    {
    var album ={name:artist_name,
    title:album_title
    }
    }else{var album ={name:artist_name,
        title:album_title,
    tracks:no_tracks}
    }
    return album;
...
console.log(make_album('Sonu Nigham', 'Dewana'));
